...
public class ByteUtils {
    ...
    public static byte[] fromHexAscii(String s, String delimiterStr) throws Exception {
     ...
     */
    public static byte[] fromOctalAscii(String s, String delimiterStr) throws Exception {
    ...
    public static byte[] fromOctalAscii(String s) throws Exception {
        try {
            int len = s.length();
            if ((len % 8) != 0) {
                throw new NumberFormatException("octal ascii must be exactly 3 digits per byte.");
            }
     ...
     * 按指定的间隔字符串，指定的进制解析s
     */
    public static byte[] fromRadixAscii(String s, String delimiterStr, int radix) throws Exception {
        Scanner scan = null;
        try {
            // int len = s.length();
            scan = new Scanner(s);
    ...
    public static byte[] fromDecimalAscii(String s, String delimiterStr) throws Exception {
        Scanner scan = null;
        try {
            // int len = s.length();
            scan = new Scanner(s);
    ...
    public static byte[] getDataOutputStreamBytes(byte[] b_data) throws Exception {
        ByteArrayOutputStream byteOut = new ByteArrayOutputStream();// 缓存
        DataOutputStream dos = new DataOutputStream(byteOut);
        try {
    ...
    public static byte[] fromBinaryAscii(String s, String delimiterStr) throws Exception {
    ...
    public static byte[] fromBinaryAscii(String s) throws Exception {
        ...
        try {
            int len = s.length();
            if ((len % 8) != 0) {
                throw new NumberFormatException("Binary ascii must be exactly 8 digits per byte.");
            }
